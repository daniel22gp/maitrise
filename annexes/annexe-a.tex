...
\draft{Voici notre échantillon tiré du corpus, faire renvoi sur chapitre évaluation, les structures d’input ont été créées à la main, sauf indication contraire les structures mid-put et outputs sont à la fois les structures attendues et celles générées par le système. Préciser que les carrés rouge sont les structures attendues, mais impossible à générer.Le main est implicite quand la structure est déjà hiérarchique, mais explicite dans l’encodage.}
