...
Voici l'échantillon grâce auquel nous avons évalué l'intégration de VerbNet à GenDR (voir la section~\ref{ch:eval}). Les structures d’input ont été créées à la main (sauf indication contraire), les structures d'outputs sont à la fois les structures attendues et celles générées par le système. Cependant comme nous n'avons pas toujours pu réaliser la phrase attendue, nous avons aussi instauré un système de couleur pour identifier les structures que nous voulions générer mais que nous n'avons pas pu. Pour ces cas particuliers, nous encadrons les structures fautives en rouges, et en vert les structures attendues. De plus, nous avons aussi encadré certaines structures en jaune lorsque la structure était fautive, mais pas par rapport aux patrons de régime des verbes (voir la discussion sur les patrons de régime des noms défaillants). Finalement, il est à préciser que le trait \texttt{main} qui indique le n\o{}eud saillant d'un réseau sémantique est parfois implicite quand la structure est déjà hiérarchique, mais explicite dans l’encodage.

\draft{Le n\oe{}ud X\_1048 représente la trace du PRO qui disparaîtra finalement en syntaxe de surface}
\begin{tabbing}
...
\begin{tabbing}
(36.1)\quad\= \emph{Version générée: Plays and ballets alternate.} \\*
\> \begin{minipage}{16cm}
...
\raisebox{-0.5\height}{~$\Rightarrow$~}
\raisebox{-0.5\height}{\includegraphics[scale=0.45]{{annexes/figs/test-eval-36.ssynt}.jpg}}
\end{minipage}
\end{tabbing}

\begin{tabbing}
(36.2)\quad\= \emph{Version attendue: Plays and ballets alternate.} \\*
\> \begin{minipage}{16cm}
\raisebox{-0.5\height}{\includegraphics[scale=0.45]{{annexes/figs/test-eval-36.sem}.jpg}}
\raisebox{-0.5\height}{~$\Rightarrow$~}
\raisebox{-0.5\height}{\includegraphics[scale=0.45]{{annexes/figs/test-eval-36.2.dsynt}.jpg}}
\raisebox{-0.5\height}{~$\Rightarrow$~}
\raisebox{-0.5\height}{\includegraphics[scale=0.45]{{annexes/figs/test-eval-36.2.ssynt}.jpg}}
\end{minipage}
\end{tabbing}
...
\begin{tabbing}
(142)\quad\= \emph{Version générée: Oils’s price increased ten percent.} \\*
\> \begin{minipage}{16cm}
...
\raisebox{-0.5\height}{~$\Rightarrow$~}
\raisebox{-0.5\height}{\includegraphics[scale=0.45]{{annexes/figs/test-eval-142.ssynt}.jpg}}
\end{minipage}
\end{tabbing}

\begin{tabbing}
(142)\quad\= \emph{Version attendue: Oils’s price increased ten percent.} \\*
\> \begin{minipage}{16cm}
\raisebox{-0.5\height}{\includegraphics[scale=0.45]{{annexes/figs/test-eval-142.sem}.jpg}}
\raisebox{-0.5\height}{~$\Rightarrow$~}
\raisebox{-0.5\height}{\includegraphics[scale=0.45]{{annexes/figs/test-eval-142.dsynt}.jpg}}
\raisebox{-0.5\height}{~$\Rightarrow$~}
\raisebox{-0.5\height}{\includegraphics[scale=0.45]{{annexes/figs/test-eval-142.2.ssynt}.jpg}}
\end{minipage}
\end{tabbing}
...
\raisebox{-0.5\height}{~$\Rightarrow$~}
\raisebox{-0.5\height}{\colorbox{YellowOrange}{\includegraphics[scale=0.45]{{annexes/figs/test-eval-330.ssynt}.jpg}}}
\end{minipage}
\\*
\> \begin{minipage}{16cm}
\raisebox{-0.5\height}{\includegraphics[scale=0.45]{{annexes/figs/test-eval-330.sem}.jpg}}
...
\raisebox{-0.5\height}{~$\Rightarrow$~}
\raisebox{-0.5\height}{\colorbox{YellowOrange}{\includegraphics[scale=0.45]{{annexes/figs/test-eval-630.ssynt}.jpg}}}
\end{minipage}
\\*
\> \begin{minipage}{16cm}
\raisebox{-0.5\height}{\includegraphics[scale=0.55]{{annexes/figs/test-eval-630.sem}.jpg}}
