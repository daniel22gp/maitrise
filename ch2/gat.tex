...
\begin{lstlisting}[language=mate, caption=Input, label=lst:realpro]
HAVE1 [tense:past]
...
\begin{lstlisting}[language=mate, caption=SPL: input de KPML, label=kpml]
...
\begin{lstlisting}[language=mate, caption=FD: input de Surge, label=surge]
((cat clause)
