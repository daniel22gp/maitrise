...
L'une des raisons qui nous a poussé à nous retourner vers une ressource lexicale verbale provient des limites du logicel MATE \citep{BohnetDevelopmentEnvironmentMTTbased2000,BOHNET10,bohnet07} que nous utilisons. Il présente des limites quant à l'encodage de multiples comortements syntaxiques pour une même entrée.
