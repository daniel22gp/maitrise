...
\chapter{Intégration des régimes de VerbNet dans GenDR}

\section{Comment générer du texte avec GenDR}
...
\subsubsection{GP dans les dictionnaires}

\subsubsection{GP dans les règles grammaticales}
