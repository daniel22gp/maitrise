...
Pour les besoins de notre travail, nous n'utilisons pas les rôles thématiques, mais nous voulions souligner qu'ils avaient une importance sémantique pour les créateurs de VerbNet. Comme nous utilisons la théorie Sens-Texte dans notre réalisateur profond, les rôles thématiques n'ont pas leur place dans les patrons de régime que nous avons extraits de VerbNet.

\draft{La relation prédicat-argument est faite en étiquettant le noeud sémantique liant le prédicat à son argument en TST. Puisqu'un prédicat peut avoir plusieurs arguments, la relation de dépendance entre lui et ses arguments doit pouvoir se distinguer. Une numérotation des arcs est donc effectuée. Tel que Melcuk le précise, les chiffres sur ces arcs ne sont pas porteurs de sens, ils n'aident qu'à distinguer les différents arguments d'un prédicat. C'est ce système que nous utiliserons pour faire notre travail et c'est pourquoi nous avons mis les rôles thématiques de côté, puisque nous en avions pas besoin.

L'information donnée par les rôles est remplacée par le concept d'actants sémantiques provenant de la théorie Sens-Texte. Melcuk a jugé que les rôles thématiques causaient des problèmes et donc remplacé ceux-ci par une numérotation formelle des arguments liés à un prédicat.\cite[pp.~227--234]{mel2012semantics}}
