...
Concrètement, cette information est encodée directement dans les entrées lexicales de VerbNet en XML. La figure~\ref{membre} montre à quoi ressemble la section \emph{Members}. On voit que \lex{deal, lend, loan, pass, peddle} et \lex{refund} sont les membres de la classe \texttt{give-13.1}.
