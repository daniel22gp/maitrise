...
\draft{p.67 "Section difficile à suivre: trop de détails de code Python, surtout on ne présente pas clairement les structures à produire. Il semble que GenDR a plusieurs types de dictionnaires qui ne sont jamais clairement présentés. Devrait donner au début un exemple de sortie attendue-entrée correspondante, incompréhensible...}
