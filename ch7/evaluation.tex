...
Avant de procéder à l'évaluation de notre système, nous devions encoder les graphes sémantiques pour qu'ils représentent les phrases que nous tenterons de générer. Nous avons ainsi encodé 978 structures sémantiques, ce qui nous a permis d'enrichir le contenu lexical de GenDR puisque certains lexèmes n'étaient pas présents dans nos dictionnaires\FL{on comprend pas le lien: tu travailles sur les inputs sémantiques, en quoi ça aide la couverture?}. Nous étions maintenant prêts à procéder à l'évaluation. Toutefois, comme nous étions limité dans le temps, nous avons pris 75 structures aléatoirement, dont 25 ont servi lors d'une phase de développement précédant la phase d'évaluation à proprement parler. \draft{ça aide la couverture parce que le lexique qui se retrouve dans chaque phrase exemple du corpus de VN a été ajouté dans la section non-verbal lexical entries, comme tous les adjectifs, noms, adverbes, qu'on a dû ajouté pour réaliser ces phrases.}
