...
\documentclass[12pt,maitrise,frenchb,natbib,twoside]{dms} % OPTION: policeTNR  pour Times New Roman
...
\input{ch4/verbnet}
\input{ch5/python}
\input{ch6/implementation}
\input{ch7/evaluation}
\input{ch8/conclusion}
